## classes20/com/dragon/read/apm/api/settings/IMemoryWarnClean$$Impl.smali
...
.method public static constructor <clinit>()V
    ...
    .line 65541
    sput-object v0, Lcom/dragon/read/apm/api/settings/IMemoryWarnClean$$Impl;->j:Lcom/google/gson/Gson;
...
.method public constructor <init>(Lcom/bytedance/news/common/settings/api/Storage;)V
    ...
    .line 17039378
    iput-object v0, p0, Lcom/dragon/read/apm/api/settings/IMemoryWarnClean$$Impl;->g:Ljava/util/concurrent/ConcurrentHashMap;

    .line 17039380
    new-instance v0, Lcom/dragon/read/apm/api/settings/IMemoryWarnClean$$Impl$a;

    .line 17039382
    iput-object p1, p0, Lcom/dragon/read/apm/api/settings/IMemoryWarnClean$$Impl;->mStorage:Lcom/bytedance/news/common/settings/api/Storage;
    ...
    .line 17039392
    iput-object p1, p0, Lcom/dragon/read/apm/api/settings/IMemoryWarnClean$$Impl;->i:Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    ...
    .line 17039398
    iput-object p1, p0, Lcom/dragon/read/apm/api/settings/IMemoryWarnClean$$Impl;->h:Lcom/bytedance/news/common/settings/internal/IEnsureWrapper;
...
.method public final getConfig()Lcom/dragon/read/apm/api/settings/MemoryWarnClean;
[MOD-CHANGED]
.method public final getConfig()Lcom/dragon/read/apm/api/settings/MemoryWarnClean;
    .registers 5
    ...
    .prologue
    .line 327680
    iget-object v0, p0, Lcom/dragon/read/apm/api/settings/IMemoryWarnClean$$Impl;->i:Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;

    .line 327682
    const-string v1, "memory_warn_clean_v653"
    ...
    .line 327693
    iget-object v0, p0, Lcom/dragon/read/apm/api/settings/IMemoryWarnClean$$Impl;->h:Lcom/bytedance/news/common/settings/internal/IEnsureWrapper;
    ...
    .line 327733
    iget-object v2, p0, Lcom/dragon/read/apm/api/settings/IMemoryWarnClean$$Impl;->h:Lcom/bytedance/news/common/settings/internal/IEnsureWrapper;

    .line 327735
    const-string v3, "get settings key = memory_warn_clean_v653"
    ...
    .line 327740
    :cond_3c
    iget-object v0, p0, Lcom/dragon/read/apm/api/settings/IMemoryWarnClean$$Impl;->g:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 327754
    check-cast v0, Lcom/dragon/read/apm/api/settings/MemoryWarnClean;
    ...
    .line 327757
    :cond_4d
    iget-object v0, p0, Lcom/dragon/read/apm/api/settings/IMemoryWarnClean$$Impl;->mStorage:Lcom/bytedance/news/common/settings/api/Storage;
    ...
    .line 327773
    :try_start_5d
    sget-object v2, Lcom/dragon/read/apm/api/settings/IMemoryWarnClean$$Impl;->j:Lcom/google/gson/Gson;

    .line 327775
    new-instance v3, Lcom/dragon/read/apm/api/settings/IMemoryWarnClean$$Impl$b;

    .line 327777
    invoke-direct {v3}, Lcom/dragon/read/apm/api/settings/IMemoryWarnClean$$Impl$b;-><init>()V
    ...
    .line 327798
    iget-object v2, p0, Lcom/dragon/read/apm/api/settings/IMemoryWarnClean$$Impl;->g:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final updateSettings(Lcom/bytedance/news/common/settings/api/SettingsData;)V
    ...
    .line 17170440
    const-string v1, "memory_warn_clean_v653_com.dragon.read.apm.api.settings.IMemoryWarnClean"
    ...
    .line 17170491
    :cond_3b
    iget-object v4, p0, Lcom/dragon/read/apm/api/settings/IMemoryWarnClean$$Impl;->h:Lcom/bytedance/news/common/settings/internal/IEnsureWrapper;
    ...
    .line 17170558
    iget-object v2, p0, Lcom/dragon/read/apm/api/settings/IMemoryWarnClean$$Impl;->mStorage:Lcom/bytedance/news/common/settings/api/Storage;
    ...
    .line 17170568
    const-string v3, "memory_warn_clean_v653"
    ...
    .line 17170576
    iget-object v4, p0, Lcom/dragon/read/apm/api/settings/IMemoryWarnClean$$Impl;->mStorage:Lcom/bytedance/news/common/settings/api/Storage;
