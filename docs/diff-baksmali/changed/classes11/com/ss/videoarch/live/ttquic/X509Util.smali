...
.method public static constructor <clinit>()V
    ...
    .line 262150
    const-class v0, Lcom/ss/videoarch/live/ttquic/X509Util;
...
.method public static INVOKEVIRTUAL_com_ss_videoarch_live_ttquic_X509Util_com_bytedance_sysoptimizer_ReceiverRegisterLancet_registerReceiver(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
[MOD-CHANGED]
.method public static INVOKEVIRTUAL_com_ss_videoarch_live_ttquic_X509Util_com_bytedance_sysoptimizer_ReceiverRegisterLancet_registerReceiver(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
    .registers 5
...
.method public static INVOKEVIRTUAL_com_ss_videoarch_live_ttquic_X509Util_com_dragon_read_aop_BroadcastAop_registerReceiver(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
[MOD-CHANGED]
.method public static INVOKEVIRTUAL_com_ss_videoarch_live_ttquic_X509Util_com_dragon_read_aop_BroadcastAop_registerReceiver(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
    .registers 7
    .annotation runtime Lme/ele/lancet/base/annotations/Proxy;
    ...
    .line 50593829
    :cond_25
    invoke-static {p0, p1, p2}, Lcom/ss/videoarch/live/ttquic/X509Util;->INVOKEVIRTUAL_com_ss_videoarch_live_ttquic_X509Util_com_bytedance_sysoptimizer_ReceiverRegisterLancet_registerReceiver(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
...
.method public static clearTestRootCertificates()V
    ...
    .line 196611
    sget-object v0, Lcom/ss/videoarch/live/ttquic/X509Util;->sLock:Ljava/lang/Object;
...
.method private static createTrustManager(Ljava/security/KeyStore;)Lcom/ss/videoarch/live/ttquic/X509Util$X509TrustManagerImplementation;
[MOD-CHANGED]
.method private static createTrustManager(Ljava/security/KeyStore;)Lcom/ss/videoarch/live/ttquic/X509Util$X509TrustManagerImplementation;
    .registers 6
    .annotation system Ldalvik/annotation/Throws;
    ...
    .line 17039385
    :try_start_19
    new-instance v3, Lcom/ss/videoarch/live/ttquic/X509Util$X509TrustManagerJellyBean;
    ...
    .line 17039390
    invoke-direct {v3, v4}, Lcom/ss/videoarch/live/ttquic/X509Util$X509TrustManagerJellyBean;-><init>(Ljavax/net/ssl/X509TrustManager;)V
    :try_end_21
...
.method private static ensureInitializedLocked()V
    ...
    .line 393233
    invoke-static {v1}, Lcom/ss/videoarch/live/ttquic/X509Util;->createTrustManager(Ljava/security/KeyStore;)Lcom/ss/videoarch/live/ttquic/X509Util$X509TrustManagerImplementation;
    ...
    .line 393282
    sput-object v0, Lcom/ss/videoarch/live/ttquic/X509Util;->sSystemCertificateDirectory:Ljava/io/File;
    :try_end_44
    ...
    .line 393335
    invoke-direct {v0, v1}, Lcom/ss/videoarch/live/ttquic/X509Util$TrustStorageListener;-><init>(Lcom/ss/videoarch/live/ttquic/X509Util$1;)V
    ...
    .line 393376
    sget-object v2, Lcom/ss/videoarch/live/ttquic/X509Util;->sTrustStorageListener:Lcom/ss/videoarch/live/ttquic/X509Util$TrustStorageListener;

    .line 393378
    invoke-static {v1, v2, v0}, Lcom/ss/videoarch/live/ttquic/X509Util;->INVOKEVIRTUAL_com_ss_videoarch_live_ttquic_X509Util_com_dragon_read_aop_BroadcastAop_registerReceiver(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
...
.method public static reloadDefaultTrustManager()V
    ...
    .line 131076
    :try_start_4
    sput-object v1, Lcom/ss/videoarch/live/ttquic/X509Util;->sDefaultTrustManager:Lcom/ss/videoarch/live/ttquic/X509Util$X509TrustManagerImplementation;

    .line 131078
    sput-object v1, Lcom/ss/videoarch/live/ttquic/X509Util;->sSystemTrustAnchorCache:Ljava/util/Set;
...
.method public static verifyServerCertificates([[BLjava/lang/String;Ljava/lang/String;)Lcom/ss/videoarch/live/ttquic/AndroidCertVerifyResult;
    ...
    invoke-static {}, Lcom/ss/videoarch/live/ttquic/X509Util;->ensureInitialized()V
    :try_end_d
    .catch Ljava/security/cert/CertificateException; {:try_start_a .. :try_end_d} :catch_b2
    ...
    .line 50724884
    invoke-static {v2}, Lcom/ss/videoarch/live/ttquic/X509Util;->createCertificateFromBytes([B)Ljava/security/cert/X509Certificate;
    ...
    :try_end_1b
    .catch Ljava/security/cert/CertificateException; {:try_start_12 .. :try_end_1b} :catch_aa
    ...
    .line 50724898
    invoke-static {v4}, Lcom/ss/videoarch/live/ttquic/X509Util;->createCertificateFromBytes([B)Ljava/security/cert/X509Certificate;
    ...
    :try_end_29
    .catch Ljava/security/cert/CertificateException; {:try_start_20 .. :try_end_29} :catch_29
    ...
    .line 50724927
    invoke-static {v1}, Lcom/ss/videoarch/live/ttquic/X509Util;->verifyKeyUsage(Ljava/security/cert/X509Certificate;)Z
    ...
    .line 50724935
    sget p1, Lcom/ss/videoarch/live/ttquic/CertVerifyStatusAndroid;->INCORRECT_KEY_USAGE:I

    .line 50724937
    invoke-direct {p0, p1}, Lcom/ss/videoarch/live/ttquic/AndroidCertVerifyResult;-><init>(I)V
    :try_end_4c
    .catch Ljava/security/cert/CertificateExpiredException; {:try_start_38 .. :try_end_4c} :catch_a2
    .catch Ljava/security/cert/CertificateNotYetValidException; {:try_start_38 .. :try_end_4c} :catch_9a
    .catch Ljava/security/cert/CertificateException; {:try_start_38 .. :try_end_4c} :catch_92
    ...
    .line 50724944
    :try_start_50
    sget-object v3, Lcom/ss/videoarch/live/ttquic/X509Util;->sDefaultTrustManager:Lcom/ss/videoarch/live/ttquic/X509Util$X509TrustManagerImplementation;
    ...
    monitor-exit v1
    :try_end_5c
    .catchall {:try_start_50 .. :try_end_5c} :catchall_8f
    ...
    :cond_5d
    :try_start_5d
    invoke-interface {v3, p0, p1, p2}, Lcom/ss/videoarch/live/ttquic/X509Util$X509TrustManagerImplementation;->checkServerTrusted([Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;

    .line 50724960
    move-result-object p0
    :try_end_61
    .catch Ljava/security/cert/CertificateException; {:try_start_5d .. :try_end_61} :catch_62
    .catchall {:try_start_5d .. :try_end_61} :catchall_8f
    ...
    :catch_62
    :try_start_62
    sget-object v3, Lcom/ss/videoarch/live/ttquic/X509Util;->sTestTrustManager:Lcom/ss/videoarch/live/ttquic/X509Util$X509TrustManagerImplementation;
    ...
    move-result-object p0
    :try_end_68
    .catch Ljava/security/cert/CertificateException; {:try_start_62 .. :try_end_68} :catch_86
    .catchall {:try_start_62 .. :try_end_68} :catchall_8f
    ...
    .line 50724985
    invoke-static {p1}, Lcom/ss/videoarch/live/ttquic/X509Util;->isKnownRoot(Ljava/security/cert/X509Certificate;)Z
    ...
    .line 50724989
    :cond_7d
    new-instance p1, Lcom/ss/videoarch/live/ttquic/AndroidCertVerifyResult;

    .line 50724991
    sget p2, Lcom/ss/videoarch/live/ttquic/CertVerifyStatusAndroid;->OK:I

    .line 50724993
    invoke-direct {p1, p2, v0, p0}, Lcom/ss/videoarch/live/ttquic/AndroidCertVerifyResult;-><init>(IZLjava/util/List;)V
    ...
    .line 50725000
    sget p1, Lcom/ss/videoarch/live/ttquic/CertVerifyStatusAndroid;->NO_TRUSTED_ROOT:I
    ...
    .line 50725020
    sget p1, Lcom/ss/videoarch/live/ttquic/CertVerifyStatusAndroid;->NOT_YET_VALID:I
    ...
    .line 50725028
    sget p1, Lcom/ss/videoarch/live/ttquic/CertVerifyStatusAndroid;->EXPIRED:I
    ...
    .line 50725036
    sget p1, Lcom/ss/videoarch/live/ttquic/CertVerifyStatusAndroid;->UNABLE_TO_PARSE:I
