...
.method private static hookFileInputStreamConstructor$$sedna$redirect$$307(Ljava/io/File;)Ljava/io/FileInputStream;
    .registers 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public static md5Hex(Ljava/io/File;)Ljava/lang/String;
    ...
    :try_end_9
    .catch Ljava/lang/Exception; {:try_start_3 .. :try_end_9} :catch_45
    ...
    invoke-static {p0}, Lcom/ss/android/socialbase/downloader/utils/DownloadDigestUtils;->hookFileInputStreamConstructor$$sedna$redirect$$307(Ljava/io/File;)Ljava/io/FileInputStream;

    move-result-object p0
    :try_end_19
    .catch Ljava/lang/Exception; {:try_start_13 .. :try_end_19} :catch_45
    .catchall {:try_start_13 .. :try_end_19} :catchall_39
    ...
    :goto_1d
    invoke-virtual {p0, v5, v1, v4}, Ljava/io/FileInputStream;->read([BII)I
    ...
    invoke-static {v3}, Lcom/ss/android/socialbase/downloader/utils/DownloadDigestUtils;->toHexString([B)Ljava/lang/String;

    move-result-object v2
    :try_end_2f
    .catch Ljava/lang/Exception; {:try_start_1b .. :try_end_2f} :catch_46
    .catchall {:try_start_1b .. :try_end_2f} :catchall_37
