.class public final Lcom/ss/android/union_series/config/settings/MUnionSeriesAdSettings$$Impl;
.super Ljava/lang/Object;
.source "SourceFile"

# interfaces
.implements Lcom/ss/android/union_series/config/settings/MUnionSeriesAdSettings;
...
.field public final i:Lcom/ss/android/union_series/config/settings/MUnionSeriesAdSettings$$Impl$a;
...
.method public constructor <init>(Lcom/bytedance/news/common/settings/api/Storage;)V
    ...
    .line 17039378
    iput-object v0, p0, Lcom/ss/android/union_series/config/settings/MUnionSeriesAdSettings$$Impl;->g:Ljava/util/concurrent/ConcurrentHashMap;

    .line 17039380
    new-instance v0, Lcom/ss/android/union_series/config/settings/MUnionSeriesAdSettings$$Impl$a;

    .line 17039382
    invoke-direct {v0}, Lcom/ss/android/union_series/config/settings/MUnionSeriesAdSettings$$Impl$a;-><init>()V

    .line 17039385
    iput-object v0, p0, Lcom/ss/android/union_series/config/settings/MUnionSeriesAdSettings$$Impl;->i:Lcom/ss/android/union_series/config/settings/MUnionSeriesAdSettings$$Impl$a;

    .line 17039387
    iput-object p1, p0, Lcom/ss/android/union_series/config/settings/MUnionSeriesAdSettings$$Impl;->mStorage:Lcom/bytedance/news/common/settings/api/Storage;
    ...
    .line 17039400
    iput-object p1, p0, Lcom/ss/android/union_series/config/settings/MUnionSeriesAdSettings$$Impl;->h:Lcom/bytedance/news/common/settings/internal/IEnsureWrapper;
...
# virtual methods
.method public final getSeriesAdConfig()Ldt7/a;
    .registers 5

    .prologue
    .line 327680
    const-string v0, "munion_series_ad_settings"
    ...
    .line 327688
    iget-object v1, p0, Lcom/ss/android/union_series/config/settings/MUnionSeriesAdSettings$$Impl;->h:Lcom/bytedance/news/common/settings/internal/IEnsureWrapper;
    ...
    .line 327728
    iget-object v2, p0, Lcom/ss/android/union_series/config/settings/MUnionSeriesAdSettings$$Impl;->h:Lcom/bytedance/news/common/settings/internal/IEnsureWrapper;

    .line 327730
    const-string v3, "get settings key = munion_series_ad_settings"
    ...
    .line 327735
    :cond_3a
    iget-object v1, p0, Lcom/ss/android/union_series/config/settings/MUnionSeriesAdSettings$$Impl;->g:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 327752
    :cond_4b
    iget-object v1, p0, Lcom/ss/android/union_series/config/settings/MUnionSeriesAdSettings$$Impl;->mStorage:Lcom/bytedance/news/common/settings/api/Storage;
    ...
    .line 327768
    const-class v2, Ldt7/b;

    .line 327770
    iget-object v3, p0, Lcom/ss/android/union_series/config/settings/MUnionSeriesAdSettings$$Impl;->i:Lcom/ss/android/union_series/config/settings/MUnionSeriesAdSettings$$Impl$a;
    ...
    .line 327776
    check-cast v2, Ldt7/b;

    .line 327778
    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    .line 327781
    invoke-static {v1}, Ldt7/b;->a(Ljava/lang/String;)Ldt7/a;
    ...
    .line 327789
    iget-object v2, p0, Lcom/ss/android/union_series/config/settings/MUnionSeriesAdSettings$$Impl;->g:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final updateSettings(Lcom/bytedance/news/common/settings/api/SettingsData;)V
    ...
    .line 17170440
    const-string v1, "mannor_union_com.ss.android.union_series.config.settings.MUnionSeriesAdSettings"
    ...
    .line 17170491
    :cond_3b
    iget-object v4, p0, Lcom/ss/android/union_series/config/settings/MUnionSeriesAdSettings$$Impl;->h:Lcom/bytedance/news/common/settings/internal/IEnsureWrapper;
    ...
    .line 17170558
    iget-object v2, p0, Lcom/ss/android/union_series/config/settings/MUnionSeriesAdSettings$$Impl;->mStorage:Lcom/bytedance/news/common/settings/api/Storage;
    ...
    .line 17170568
    const-string v3, "munion_series_ad_settings"
    ...
    .line 17170576
    iget-object v4, p0, Lcom/ss/android/union_series/config/settings/MUnionSeriesAdSettings$$Impl;->mStorage:Lcom/bytedance/news/common/settings/api/Storage;
